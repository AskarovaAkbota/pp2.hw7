...
leftarm = pygame.image.load("images/l-hand.png")
rightarm = pygame.image.load("images/r-hand.png")
...
while not done:
    ...
    rotated_rightarm = pygame.transform.rotate(pygame.transform.scale(rightarm, (600, 800)), -minute_angle)
    rightarmrect = rotated_rightarm.get_rect(center = (800//2, 600//2 + 12))
    screen.blit(rotated_rightarm, rightarmrect)
    rotated_leftarm = pygame.transform.rotate(pygame.transform.scale(leftarm, (40.99, 682.5)), -second_angle)
